...
contract Identity is Storage, IIdentity, Version {
    ...
    /**
     * @notice requires authorization to call this function
     */
    modifier onlyAuthorized() {
        require(
            authorizedEntities[msg.sender],
            "Not authorized to access claims"
        );
        _;
    }
    ...
    /**
     * @dev Adds an address to the list of authorized entities
     * @param entity The address to be authorized
     */
    function authorizeEntity(address entity) external onlyManager {
        authorizedEntities[entity] = true;
    }

    /**
     * @dev Removes an address from the list of authorized entities
     * @param entity The address to be unauthorized
     */
    function revokeEntity(address entity) external onlyManager {
